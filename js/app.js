...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var formio_wizard_vite_wrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! formio-wizard-vite-wrapper */ \"./node_modules/formio-wizard-vite-wrapper/dist/formio-wizard-vite-wrapper.es.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  name: 'App',\n  components: {\n    FormWrapper: formio_wizard_vite_wrapper__WEBPACK_IMPORTED_MODULE_0__.FormWrapper\n  },\n\n  data() {\n    return {\n      // FormIO\n      projectUrl: window.formDetails.VUE_APP_PROJECT_URL,\n      wizardUrl: `${window.formDetails.VUE_APP_PROJECT_URL}/${window.formDetails.VUE_APP_FORM_PATH}`,\n      createFormUrl: window.formDetails.VUE_APP_WIZARD_URL,\n      formIdentifier: `${window.formDetails.VUE_APP_NAME}-${window.formDetails.VUE_APP_ENV}`,\n      formName: `${window.formDetails.VUE_APP_FORM_NAME}`,\n      purchaseItemName: window.formDetails.VUE_APP_PURCHASE_ITEM_NAME,\n      // Matrix page\n      savedApplicationPage: window.formDetails.VUE_APP_SAVED_APPLICATION_PAGE,\n      thankYouPage: window.formDetails.VUE_APP_THANK_YOU_PAGE,\n      guidePageUrl: window.formDetails.VUE_APP_GUIDE_PAGE_URL,\n      // submission\n      submissionId: '',\n      // payment\n      hasPayment: window.formDetails.VUE_APP_HAS_PAYMENT,\n      paymentUrl: window.formDetails.VUE_APP_PAYMENT_URL,\n      recaptchaSiteKey: window.formDetails.VUE_APP_RECAPTCHA_SITE_KEY,\n      // temp user authentication\n      shortUuidToken: '',\n      feesCode: window.formDetails.VUE_APP_FEECODE,\n      feesUrl: window.formDetails.VUE_APP_FEE_URL,\n      privateKey: window.formDetails.VUE_APP_PRIVATE_KEY,\n      authUrl: window.formDetails.VUE_APP_AUTH_URL,\n      formInfo: window.formDetails.VUE_APP_FORM_INFO\n    };\n  },\n\n  beforeMount() {\n    let queryString = window.location.search;\n    let urlParams = new URLSearchParams(queryString);\n    let submissionId = urlParams.get('submissionId') ?? '';\n    let shortUuidToken = urlParams.get('token') ?? '';\n    this.createFormUrl = this.wizardUrl;\n\n    if (submissionId !== '' && shortUuidToken !== '') {\n      this.createFormUrl += '/submission/' + submissionId;\n    }\n\n    this.submissionId = submissionId;\n    this.shortUuidToken = shortUuidToken;\n  }\n\n});\n\n//# sourceURL=webpack://app/./src/App.vue?./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use%5B0%5D!./node_modules/vue-loader/dist/index.js??ruleSet%5B0%5D.use%5B0%5D");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"render\": function() { return /* binding */ render; }\n/* harmony export */ });\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.runtime.esm-bundler.js\");\n\nconst _hoisted_1 = {\n  id: \"formio-land-form\"\n};\n\nconst _hoisted_2 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)(\"small\", null, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)(\"cite\", null, \"(Land Act 1994)\")], -1\n/* HOISTED */\n);\n\nconst _hoisted_3 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)(\"div\", {\n  class: \"clearfix\"\n}, null, -1\n/* HOISTED */\n);\n\nfunction render(_ctx, _cache, $props, $setup, $data, $options) {\n  const _component_FormWrapper = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)(\"FormWrapper\");\n\n  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(\"div\", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)(\"h1\", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.formName) + \" \", 1\n  /* TEXT */\n  ), _hoisted_2]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FormWrapper, {\n    projectUrl: $data.projectUrl,\n    wizardUrl: $data.wizardUrl,\n    createFormUrl: $data.createFormUrl,\n    formIdentifier: $data.formIdentifier,\n    savedApplicationPage: $data.savedApplicationPage,\n    thankYouPage: $data.thankYouPage,\n    submissionId: $data.submissionId,\n    hasPayment: $data.hasPayment,\n    paymentUrl: $data.paymentUrl,\n    recaptchaSiteKey: $data.recaptchaSiteKey,\n    purchaseItemName: $data.purchaseItemName,\n    guidePageUrl: $data.guidePageUrl,\n    shortUuidToken: $data.shortUuidToken,\n    feesCode: $data.feesCode,\n    feesUrl: $data.feesUrl,\n    privateKey: $data.privateKey,\n    authUrl: $data.authUrl,\n    formInfo: $data.formInfo\n  }, null, 8\n  /* PROPS */\n  , [\"projectUrl\", \"wizardUrl\", \"createFormUrl\", \"formIdentifier\", \"savedApplicationPage\", \"thankYouPage\", \"submissionId\", \"hasPayment\", \"paymentUrl\", \"recaptchaSiteKey\", \"purchaseItemName\", \"guidePageUrl\", \"shortUuidToken\", \"feesCode\", \"feesUrl\", \"privateKey\", \"authUrl\", \"formInfo\"]), _hoisted_3]);\n}\n\n//# sourceURL=webpack://app/./src/App.vue?./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use%5B0%5D!./node_modules/vue-loader/dist/templateLoader.js??ruleSet%5B1%5D.rules%5B3%5D!./node_modules/vue-loader/dist/index.js??ruleSet%5B0%5D.use%5B0%5D");
